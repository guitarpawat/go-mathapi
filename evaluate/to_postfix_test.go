...
func Test_InfixToPostfix_Normal(t *testing.T) {
	table := []testTable{
		...
		{[]string{"(", "8", "add", "9", "mul", "(", "4", "add", "5", "mul", "7", "add", "6", ")", ")", "add", "3", "mul", "5", "add", "4"},
			[]string{"8", "9", "4", "5", "7", "mul", "add", "6", "add", "mul", "add", "3", "5", "mul", "add", "4", "add"}},
		{[]string{"(", "300", "add", "23", ")", "mul", "(", "43", "sub", "21", ")", "div", "(", "84", "add", "7", ")"},
			[]string{"300", "23", "add", "43", "21", "sub", "mul", "84", "7", "add", "div"}},
		{[]string{"(", "4", "add", "8", ")", "mul", "(", "6", "sub", "5", ")", "div", "(", "(", "3", "sub", "2", ")", "mul", "(", "2", "add", "2", ")", ")"},
